            ...
            <div className="mt-12 w-full flex flex-col items-center">
              <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                ...
                <button
                  ...
                  title="Trò chuyện"
                  className="cursor-pointer w-30 h-30 md:w-30 md:h-30 rounded-full bg-pink-500 text-white flex items-center justify-center md:text-xl font-extrabold shadow-lg transform transition hover:scale-105 focus:outline-none focus:ring-4 focus:ring-pink-300/60"
                >
                  Trò chuyện
                </button>
              </div>
